...
namespace WindowsForms
{
    public partial class Form1 : Form
    {
        ...
        private void SetControlsVisibility(bool visible_controls)
        {
            ...
            this.showContolsToolStripMenuItem.Checked = visible_controls;
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            notifyIcon.Text = DateTime.Now.ToString("hh:mm:ss tt");
        }
        ...
        private void showContolsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (showContolsToolStripMenuItem.Checked) label1_DoubleClick(sender, e);
